...
if sym_derivs:
    ...
    unique_loc_net = network.unique_locs_det_responses(network_specs,f,inj_params,deriv_symbs_string,wf_model_name,wf_other_var_dic,conv_cos,conv_log,use_rot,num_cores,step,method,order,d_order_n)
