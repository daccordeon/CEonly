...
srun mprof run -o "mprof_plot_plotters_${OFFSET_TASK_ID}.dat" /fred/oz209/jgardner/CEonlyPony/source/run_plot_detection_rate_and_measurement_errors.py ${OFFSET_TASK_ID}; mprof plot -o "mprof_plot_plotters_${OFFSET_TASK_ID}.pdf" "mprof_plot_plotters_${OFFSET_TASK_ID}.dat"
